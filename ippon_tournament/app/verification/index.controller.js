(function () {
    ...
    angular
        .module('app')
        .controller('Verification.IndexController', Controller);
     ...
     function Controller($window, UserService, PlayerService, FlashService) {
        ...
        function getAllPlayers() {
            PlayerService.GetAllForVerify(localStorage.actualCompetition).then(function(result) {               
                vm.players = result;            
            });         
        }
